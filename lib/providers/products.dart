...
class Products with ChangeNotifier {
  ...
  Future<void> fetchAndSetProducts() async{
    ...
    extractedData.forEach((prodId, prodData) {
      loadedProducts.add(Product(id: prodId, title: prodData["title"], description: prodData["description"], imageUrl: prodData["imageUrl"], price: prodData["price"], isFavourite: prodData["isFavourite"]));
